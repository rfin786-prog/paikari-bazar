...
```
  ...
  <div className="p-4 flex flex-col flex-1">
    ...
    {product.unit && (
      <p className="text-xs text-gray-400 mb-2">প্রতি {product.unit}</p>
    )}
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                <button
                  onClick={() => onUpdateQty(item.id, item.qty + 1)}
                  className="w-6 h-6 rounded-full bg-indigo-100 text-indigo-700 text-sm font-bold flex items-center justify-center hover:bg-indigo-200"
                >
                  +
                </button>
                <button
...
<span className="font-bold text-indigo-700 text-lg leading-tight">
পাইকারি<br className="hidden sm:block" />
<span className="text-gray-800">বাজার</span>
</span>
</Link>
...
```
      ...
      <button
        ...
        className="relative flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-xl text-sm font-medium transition-colors flex-shrink-0"
      >
        🛒
