...
```
  ...
  {/* ✅ FIX: Fixed height wrapper — layout কখনো shift করবে না */}
  <div style={{ maxWidth: '520px', minHeight: '280px', display: 'flex', flexDirection: 'column' }}>
    ...
    <h1 style={{
      ...
      lineHeight: '1.6',
      marginBottom: '14px',
      // ✅ FIX: দুই লাইনের জন্য যথেষ্ট minHeight
      minHeight: '110px',
    }}>
      <span
    ...
    {/* ✅ FIX: && এর বদলে opacity + visibility — জায়গা সবসময় ধরে রাখে */}
    <p style={{
    ...
    {/* ✅ FIX: button ও সবসময় DOM-এ আছে, শুধু invisible */}
    <button
